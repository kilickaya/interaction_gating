...
# 1) dump annotation
#ds_hico._101_prepare_annotation_cint()
# 2) subject-object
#ds_hico._203_pickle_features_subject_object_cint()
# 3) local scene 
#ds_hico._203_pickle_features_local_scene_cint()
# 4) deformation
#ds_hico._203_pickle_features_deformation_cint()
# 5) lvis
#ds_hico._202_pickle_features_lvis_cint()
# 6) pairatt
#ds_hico._201_pickle_features_pairattn_cint()
# 7) contextfusion
#ds_hico._201_pickle_features_contfus_cint()
# 8) vgg
#ds_hico._202_pickle_features_vgg_cint()
...
path_feature = 'Cint/features/extra/features_local_scene.h5'
...
path_save  = Pth('Cint/features/h5/local_scene.h5')
...
path_feature = 'Cint/features/extra/features_deformation.h5'
path_feature = Pth(path_feature)
feat_shape = (80, 1, 32, 32)

path_model = '/var/scratch/mkilicka/data/hico/models_finetuned/deformation/model.pt'
path_save  = Pth('Cint/features/h5/features_deformation.h5')
...
if backbone == 'rcnn':
    features_interaction = Pth('Cint/features/features_subject_object.h5')
    ...
    features_interaction = Pth('Cint/features/h5/features_contextfusion.h5')
    ...
    features_interaction = Pth('Cint/features/h5/features_pairattn.h5')
    n_channels, n_regions, channel_side_dim = 4096, 3,1  
    input_shape = (n_channels, n_regions, channel_side_dim, channel_side_dim)
    (x_te)    = utils.h5_load(features_interaction, 'x_te')
    x_te = np.swapaxes(x_te, 1,2)
    ...
    features_interaction = Pth('Cint/features/h5/resnet.h5')
...
feature_path_c1 = Pth('Cint/features/h5/features_lvis.h5')
feature_path_c2 = Pth('Cint/features/h5/local_scene.h5')
feature_path_c3= Pth('Cint/features/h5/features_deformation.h5')
...
path_save  = '/var/scratch/mkilicka/code/context-driven-interactions/submission/data/cint/results/early_fusion.h5'
...
path_save  = '/var/scratch/mkilicka/code/context-driven-interactions/submission/data/cint/results/late_fusion_pairatt.h5'
...
path_save  = '/var/scratch/mkilicka/code/context-driven-interactions/submission/data/cint/results/early_gating.h5'
...
# Run actual feed-forward here
x_te = pytorch_utils.batched_feedforward_multi(model,[x_te_c1], batch_size, func_name='feature_extractor')
