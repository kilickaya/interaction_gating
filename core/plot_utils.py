...
def tableau_colors(as_float=True):
    # Tableau 10 Colors
    # blue, orange, green, red, green-yellow, link pink, brown, purple, gray, cyan
    cols = [(31, 119, 180), (255, 127, 14), (44, 160, 44), (214, 39, 40), (188, 189, 34), (227, 119, 194), (140, 86, 75), (148, 103, 189), (127, 127, 127), (23, 190, 207), (199, 199, 199), (23, 190, 207), (247, 182, 210), (155, 223, 138),
            (255, 187, 120), (65, 68, 81)]

    # Convert to range [0, 1] for MPL
    if as_float:
        cols = int_to_float(cols)
